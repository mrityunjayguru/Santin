    ...
    <div class="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 mb-4 flex-shrink-0">
        ...
        <div class="flex items-center space-x-2 md:space-x-3 w-full lg:w-auto">
            <a href="{{ route('art.create') }}"
                class="flex-1  lg:flex-none text-center px-4 md:px-6 py-3 bg-[#2B2B2B] text-white rounded-full text-xs md:text-sm font-medium  hover:bg-[#3B3B3B] transition-colors">Download</a>
        </div>
    </div>
    <!-- Filters -->
    ...
    <div id="grid-view"
        ...
        <div class="group cursor-pointer art-card" data-current-slide="0">
            ...
            <div class="flex items-center justify-between mt-2 px-1">
                <label class="flex items-center gap-2 cursor-pointer" onclick="event.stopPropagation()">
                    <input type="checkbox" class="rounded border-gray-300 text-[#2B2B2B] focus:ring-[#2B2B2B] w-4 h-4">
                    <span class="text-xs md:text-sm font-medium text-gray-700">The Starry Night</span>
                </label>
                <a href="#" class="text-[#4A6FFF] text-xs md:text-sm font-medium hover:text-blue-700 transition-colors"
        ...
        <div class="group cursor-pointer art-card" data-current-slide="0">
            ...
            <div class="flex items-center justify-between mt-2 px-1">
                <label class="flex items-center gap-2 cursor-pointer" onclick="event.stopPropagation()">
                    <input type="checkbox" class="rounded border-gray-300 text-[#2B2B2B] focus:ring-[#2B2B2B] w-4 h-4">
                    <span class="text-xs md:text-sm font-medium text-gray-700">Colourful eyes</span>
                </label>
                <a href="#" class="text-[#4A6FFF] text-xs md:text-sm font-medium hover:text-blue-700 transition-colors"
                    onclick="event.stopPropagation()">Download</a>
            </div>
        ...
        <div class="group cursor-pointer art-card" data-current-slide="0">
            ...
            <div class="flex items-center justify-between mt-2 px-1">
                <label class="flex items-center gap-2 cursor-pointer" onclick="event.stopPropagation()">
                    <input type="checkbox" class="rounded border-gray-300 text-[#2B2B2B] focus:ring-[#2B2B2B] w-4 h-4">
                    <span class="text-xs md:text-sm font-medium text-gray-700">Splatter of joy</span>
                </label>
                <a href="#" class="text-[#4A6FFF] text-xs md:text-sm font-medium hover:text-blue-700 transition-colors"
                    onclick="event.stopPropagation()">Download</a>
            </div>
        ...
        <table class="min-w-full text-sm text-[#2B2B2B]" style="border-collapse: separate; border-spacing: 0;">
            <thead class="bg-white">
                <tr>
                    ...
                    <th class="px-5 py-4 text-left text-[13px] font-medium text-[#9CA3AF] border-b border-[#D1D5DB]">
                        Type</th>
                    <th class="px-5 py-4 text-left text-[13px] font-medium text-[#9CA3AF] border-b border-[#D1D5DB]">Art
                        ID</th>
                    <th class="px-5 py-4 text-center text-[13px] font-medium text-[#9CA3AF] border-b border-[#D1D5DB]">
                        Preview
                    </th>
                    <th
            ...
            <tbody>
                ...
                <tr class="hover:bg-[#FAFAFA] transition-colors">
                    <td class="px-5 py-4 font-medium text-[#374151] border-b border-[#D1D5DB]">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox"
                                class="rounded border-gray-300 text-[#2B2B2B] focus:ring-[#2B2B2B] w-4 h-4">
                    ...
                    <td class="px-5 py-4 text-right border-b border-[#D1D5DB]">
                        <a href="#"
                            class="inline-block px-4 py-1.5 bg-[#F3F4F6] text-[#4A6FFF] hover:bg-[#E5E7EB] rounded-full text-xs font-medium transition-colors">Download</a>
                    </td>
                </tr>
                ...
                <!-- Row 3 -->
                <tr class="hover:bg-[#FAFAFA] transition-colors">
                    <td class="px-5 py-4 font-medium text-[#374151] rounded-bl-xl">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox"
                                class="rounded border-gray-300 text-[#2B2B2B] focus:ring-[#2B2B2B] w-4 h-4">
                            <span>The Starry Night</span>
                    ...
                    <td class="px-5 py-4 text-right rounded-br-xl">
                        <a href="#"
                            class="inline-block px-4 py-1.5 bg-[#F3F4F6] text-[#4A6FFF] hover:bg-[#E5E7EB] rounded-full text-xs font-medium transition-colors">Download</a>
                    </td>
                </tr>
